...
![Bilgisayar Aracı demo](./demo.gif)

> *Animasyon arayüzü **temsili** olarak gösterir (gerçek ekran kaydı değildir, sistem bilgileri örnektir). Kendi kaydınızı [ScreenToGif](https://www.screentogif.com/) ile alıp bu dosyanın yerine koyabilirsiniz.*
