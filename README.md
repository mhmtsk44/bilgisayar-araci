...
### 📦 Uygulama
- Toplu uygulama kurulumu (liste ile)
...
- Windows loglarını temizleme
- Windows Update önbelleğini temizleme
- Geri dönüşüm kutusunu boşaltma
- Disk Temizleme (cleanmgr)
- Ekran kartı sürücü artıklarını temizleme
- Sistem dosyalarını onarma (SFC)
...
### 🔧 Bakım
- Windows güncellemelerini tarama
