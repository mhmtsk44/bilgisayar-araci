...
|:-:|---|
| 12 | Sürücü Yedekle |
| 13 | Sürücü Geri Yükle |

### 🛠️ Bakım

| # | İşlem |
|:-:|---|
| 14 | Sistem ve Disk Onarımı (SFC / DISM / chkdsk) |
| 15 | Güvenli USB Oluştur (Korumalı) |
| 16 | Windows Güncellemelerini Tara |
| 17 | Ağ Ayarlarını Sıfırla |
| 18 | Geri Yükleme Noktası Oluştur |
| 19 | Yazıcı Kuyruğunu Temizle |
...
| 20 | Sistem Bilgileri |
| 21 | Disk Özeti |
| 22 | Disk Sağlığı (SMART) |
| 23 | Başlangıç Programları |
| 24 | Sistem Sağlık Özeti |

### ⚙️ Diğer

| # | İşlem |
|:-:|---|
| 25 | Yönetim Klasörleri Oluştur |
| 26 | Yardım / Hakkında |
| 00 | Çıkış |
