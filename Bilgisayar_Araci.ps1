...
# Betiğin indirileceği adres (kısaltılmış linkin buraya yazılmalı)
$ScriptUrl = "https://tinyurl.com/27kxfp7y"
...
function Get-BaslatmaKomutu {
    if (-not [string]::IsNullOrWhiteSpace($BetikYolu) -and (Test-Path $BetikYolu)) {
        ...
        # Artık Trim ve BOM derdi yok, çünkü linkin doğrudan UTF-8 dosyaya gidiyor
